        ...
        <ReactMarkdown
          ...
          components={{
            ...
            img(props) {
              return (
                <img
                  className="my-4 max-full rounded"
                  src={src}
                  alt={alt}
                  {...props}
                />
            ...
            table({ children }) {
              return (
                <div className="overflow-x-auto my-4">
                  <table className="min-w-full divide-y divide-gray-300 border border-b-gray-200">
                    {children}
                  </table>
                </div>
              );
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center jsutify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
